      ...
      <div className="flex h-full max-h-[90vh] w-full max-w-4xl flex-col rounded-3xl bg-white shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <form id="editEmployeeForm" onSubmit={handleSubmit} className="space-y-8">
            {/* 1. Personal Details */}
            <section>
              <h3 className="mb-4 text-lg font-semibold text-slate-800">Personal Details</h3>
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 px-4 py-2 text-sm outline-none transition focus:border-violet-500 focus:ring-2 focus:ring-violet-200"
                    required
                  />
                </div>
                <div>
            ...
            <section>
              <h3 className="mb-4 text-lg font-semibold text-slate-800">Professional Details</h3>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <div>
                  ...
                  <select
                    ...
                    value={form.status}
                    onChange={handleChange}
                    className="w-full rounded-xl border border-slate-200 px-4 py-2 text-sm outline-none transition focus:border-violet-500 focus:ring-2 focus:ring-violet-200 font-semibold text-slate-800"
                  >
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-slate-700">Default Shift</label>
                  <select
                    name="defaultShift"
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-slate-700">Default Duty</label>
                  <select
                    name="defaultDuty"
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-slate-700">Duty Location</label>
                  <select
                    name="dutyLocation"
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-slate-700">Weekly Off</label>
                  <select
                    name="weeklyOff"
            ...
            {/* 3. Account Details */}
            <section>
              <h3 className="mb-4 text-lg font-semibold text-slate-800">Bank Account Details</h3>
              <div className="grid gap-4 md:grid-cols-2">
                <div>
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-100 p-6 bg-slate-50/50 rounded-b-3xl">
          <button
            type="button"
            onClick={onClose}
