  ...
  if (registrationSuccess) {
      return (
          <div className="rounded-3xl border border-slate-200 bg-temple-100 p-5 flex flex-col items-center">
             ...
             <button onClick={startVideo} className="mt-4 px-4 py-2 bg-slate-50 text-slate-700 font-semibold rounded-full border border-slate-200 hover:bg-slate-100 transition">
                  Retake Registration
             </button>
          </div>
      );
    ...
    <div className="rounded-3xl border border-slate-200 bg-temple-100 p-5">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative mt-4">
          ...
          {stream && (
            <div className="absolute top-3 right-3 bg-blue-100 text-blue-800 px-3 py-1 text-xs font-bold rounded-full shadow-lg">
