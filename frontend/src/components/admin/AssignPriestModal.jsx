  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-3xl bg-temple-100 p-6 shadow-2xl">
        ...
        <div className="mb-6">
          <label className="block text-sm font-semibold text-slate-700 mb-2">Select Priest</label>
          {fetching ? (
            ...
            <select
              ...
              className="w-full rounded-xl border border-slate-200 px-4 py-3 outline-none focus:border-violet-500 bg-slate-50"
            >
