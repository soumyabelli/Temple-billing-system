      ...
      <div className="rounded-2xl border border-[#ece8e1] bg-white p-8 shadow-sm">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`rounded-3xl px-5 py-3 text-sm font-semibold transition ${
                activeTab === "grid" ? "bg-[#0f766e] text-white" : "bg-[#f1f5f9] text-[#475569] hover:bg-[#e2e8f0]"
              }`}
            >
            ...
            <button
              ...
              className={`rounded-3xl px-5 py-3 text-sm font-semibold transition ${
                activeTab === "add-room" ? "bg-[#0f766e] text-white" : "bg-[#f1f5f9] text-[#475569] hover:bg-[#e2e8f0]"
              }`}
            >
            ...
            <button
              ...
              className={`rounded-3xl px-5 py-3 text-sm font-semibold transition ${
                activeTab === "history" ? "bg-[#0f766e] text-white" : "bg-[#f1f5f9] text-[#475569] hover:bg-[#e2e8f0]"
              }`}
            >
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-5">
          ...
          <div className="rounded-3xl border border-[#d1fae5] bg-[#ecfdf5] p-5">
            ...
            <p className="mt-4 text-[2rem] font-bold text-[#166534]">{metrics.available}</p>
          </div>
          ...
          <div className="rounded-3xl border border-[#e0e7ff] bg-[#eef2ff] p-5">
            <p className="text-sm uppercase tracking-[0.24em] text-[#3730a3]">Total Room Rent</p>
            <p className="mt-4 text-[2rem] font-bold text-[#3730a3]">{formatCurrency(metrics.totalRent)}</p>
          </div>
        </div>
      </div>
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-1">
                          <button
                            ...
                            className="w-1/2 rounded-lg border border-amber-300 py-1 text-[11px] font-semibold text-amber-800 transition hover:bg-amber-100"
                          >
                            Maint.
                          </button>
                          <button
                            onClick={() => handleDeleteRoom(room.number)}
                            className="w-1/2 rounded-lg border border-red-300 py-1 text-[11px] font-semibold text-red-800 transition hover:bg-red-100"
                          >
                            Delete
                          </button>
                        </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <label className="block">
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-[#cbd5e1] px-3 py-2 text-sm bg-white outline-none focus:border-[#2563eb]"
                    >
                      <option value="Standard">Standard</option>
                      <option value="Deluxe">Deluxe</option>
                      <option value="VIP Suite">VIP Suite</option>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  ...
                  <label className="block">
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-[#cbd5e1] px-3 py-2 text-sm bg-white outline-none"
                    >
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out ${
                        newIsActive ? "bg-green-600" : "bg-slate-300"
                      }`}
                    >
                      <span
                        className={`pointer-events-none inline-block h-5 h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
                    ...
                    <tr key={record.id} className="border-b border-[#f1f5f9] hover:bg-[#f8fafc]">
                      ...
                      <td className="px-4 py-4">
                        <button
                          ...
                          className="flex items-center gap-1 text-xs font-bold text-blue-600 hover:text-blue-800 border border-blue-200 rounded px-2.5 py-1 transition hover:bg-blue-50"
                        >
            ...
            <form onSubmit={handleCheckinSubmit} className="mt-4 space-y-4 text-sm">
              ...
              <label className="block">
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-slate-300 px-3 py-2 outline-none focus:border-blue-600 bg-white"
                >
                  <option>UPI</option>
                  <option>Cash</option>
                  <option>Card</option>
              ...
              <div className="rounded-lg bg-emerald-50 p-4 border border-emerald-200 text-emerald-950 font-bold flex justify-between">
