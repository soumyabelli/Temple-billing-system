...
const AdminGRN = () => {
  return (
    <div className="p-4 md:p-8 bg-[#faf9f7] min-h-screen">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[#1d1b19]">Goods Received Notes</h1>
        <p className="text-sm text-[#5c6675]">Verify and approve Goods Received Notes (GRN).</p>
