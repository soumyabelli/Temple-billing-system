           ...
           <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200 h-fit">
              ...
              <form onSubmit={handleSaveLocation} className="space-y-4">
                 <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <button 
                        ...
                        className="text-xs font-bold text-blue-600 hover:text-blue-800 bg-blue-50 px-2 py-1 rounded-md transition"
                      >
                 ...
                 <div className="flex gap-2 pt-2">
                    <button type="submit" className="flex-1 bg-emerald-600 text-white py-2 rounded-xl font-semibold hover:bg-emerald-500 transition">
                    ...
                    locations.map(loc => (
                       <div key={loc._id} className="bg-white border border-slate-200 p-4 rounded-xl flex items-center justify-between hover:shadow-md transition">
                          ...
                          <div className="flex items-center gap-2">
                             ...
                             <button onClick={() => handleDeleteLocation(loc._id)} className="p-2 text-rose-600 hover:bg-rose-50 rounded-lg transition">
                                <FiTrash2 />
                             </button>
                          </div>
                       </div>
