...
const BankInterest = () => {
 ...
 <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-6">Record Bank Interest</h2>
 ...
 <div>
 <label className="block text-sm font-medium text-slate-800 dark:text-slate-200 mb-1">Amount (₹)</label>
 <input
 type="number"
 required
 min="0"
 ...
 className="w-full bg-slate-50 dark:bg-[#0f172a] dark:text-slate-200 dark:border-slate-700 dark:bg-[#0f172a] dark:text-slate-200 dark:border-slate-700 dark:bg-[#0f172a] dark:text-slate-200 dark:border-slate-700 dark:bg-[#0f172a] border border-slate-200 dark:border-slate-700 rounded-lg px-4 py-2 text-slate-800 dark:text-slate-200 placeholder-slate-400 dark:placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-amber-500"
 placeholder="Enter interest amount"
 />
 </div>
 <div>
 <label className="block text-sm font-medium text-slate-800 dark:text-slate-200 mb-1">Date</label>
 <input
 type="date"
 required
 value={formData.date}
 ...
 <div>
 <label className="block text-sm font-medium text-slate-800 dark:text-slate-200 mb-1">Description (Optional)</label>
 <textarea
 rows="3"
