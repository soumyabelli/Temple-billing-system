...
const DonationManagement = () => {
  ...
  const fetchDonations = async () => {
    try {
      ...
      const fetched = Array.isArray(res.data?.donations) ? res.data.donations : [];

      setDonations(fetched);
      setFilteredDonations(fetched);
    ...
    <div className="space-y-6 mt-5 text-slate-800 dark:text-slate-200 ">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.45fr_0.95fr]">
        ...
        <div className="grid gap-6">
          ...
          <div className="rounded-[32px] border border-amber-200/60 bg-temple-100 dark:bg-[#0f172a] dark:text-slate-200 dark:border-slate-700 p-6 shadow-md backdrop-blur-lg">
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <span className="inline-flex items-center rounded-2xl border border-amber-300 bg-amber-50 dark:bg-[#0f172a] dark:text-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm font-bold text-amber-900">
