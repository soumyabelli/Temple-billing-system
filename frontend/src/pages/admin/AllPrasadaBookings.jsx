...
const AllPrasadaBookings = () => {
  ...
  const loadOrders = useCallback(async () => {
    ...
    try {
      ...
      console.error("Failed to load all prasada orders", loadError);
          ...
          <div>
            <div className="flex items-center gap-3">
              <button
                ...
                className="rounded-full border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-1 text-xs font-bold text-slate-700 dark:text-slate-200 hover:bg-slate-100 transition"
              >
                ← Back
              </button>
              <h1 className="text-[36px] font-bold text-[#111827] dark:text-slate-200">All Prasada Bookings</h1>
            </div>
            <p className="mt-2 text-[#525252] dark:text-slate-400">
              Complete historical ledger of all online devotee and counter prasada bookings.
            </p>
          </div>
      ...
      <div className="rounded-2xl border border-[#ece8e1] dark:border-slate-700 bg-temple-100 dark:bg-[#0f172a] p-6 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            <h2 className="text-2xl font-bold text-[#111827] dark:text-slate-200">All Records</h2>
