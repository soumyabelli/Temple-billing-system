...
const AllPrasadaBookings = () => {
 ...
 <div>
 <h1 className="text-[42px] font-bold text-[#111827] dark:text-slate-200 ">All Prasada Bookings</h1>
 <p className="mt-2 text-[#525252]">Complete list of all prasada orders from devotees.</p>
 </div>
 <button
 onClick={() => navigate("/admin/prasada/booked")}
 className="rounded-3xl bg-[#eff6ff] dark:bg-[#0f172a] dark:text-slate-200 dark:border-slate-700 dark:bg-[#0f172a] px-5 py-3 text-sm font-semibold text-[#1d4ed8] dark:text-slate-200 hover:bg-[#dbeafe] dark:bg-[#0f172a] dark:text-slate-200 dark:border-slate-700 "
 >
 Back to Prasada
 </button>
 </div>
 ...
 <h2 className="text-2xl font-bold text-[#111827] dark:text-slate-200 ">All Prasada Bookings</h2>
